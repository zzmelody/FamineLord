...
// #include "Private/AssetTypeActions_FLContextEffectsLibrary.h"
// #include "Validation/EditorValidator.h"
// #include "GameEditorStyle.h"
// #include "GameModes/FLExperienceManager.h"

#define LOCTEXT_NAMESPACE "FLEditor"
 ...
 * FFLEditorModule
 */
class FFLEditorModule : public FDefaultGameModuleImpl
{
	typedef FFLEditorModule ThisClass;
	...
	virtual void StartupModule() override
	{
		...
		// if (!IsRunningGame())
		// {
		// 	FModuleManager::Get().OnModulesChanged().AddRaw(this, &FFLEditorModule::ModulesChangedCallback);
		//
		...
		//
		// AssetTools.RegisterAssetTypeActions(MakeShareable(new FAssetTypeActions_FLContextEffectsLibrary));
	}

	void OnBeginPIE(bool bIsSimulating)
	{
		// UFLExperienceManager* ExperienceManager = GEngine->GetEngineSubsystem<UFLExperienceManager>();
...
IMPLEMENT_MODULE(FFLEditorModule, FLEditor);
