...
class PUERTS_API UPuertsSetting : public UObject
{
    GENERATED_BODY()
public:
    UPROPERTY(config, EditAnywhere, Category = "Engine Class Extends Mode",
        meta = (defaultValue = "Scripts/TypeScript", Tooltip = "Game JavaScript Source Code Root Path (Relative to ProjectDir) ", DisplayName = "Game JavaScript Root"))
    FString RootPath = "Scripts/TypeScript";
    ...
    UPROPERTY(config, EditAnywhere, Category = "Declaration Generator",
        meta = (defaultValue = "Scripts/TypeScript/Typing", Tooltip = "Typing Generate Path (Relative to ProjectDir)", DisplayName = "Typing Generate Path"))
    FString TypeingGeneratePath = "Scripts/TypeScript/Typing";
};
