...
#endif
// { @luochangan	
    virtual const FString GetJsRootPath() = 0;

    virtual const FString GetTsRootPath() = 0;
    
    virtual const FString GetTypingGenerateRootPath() = 0;

    virtual const int32 GetCommandLineDebugPort() = 0;
// } @luochangan		
};
