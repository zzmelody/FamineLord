...
// @luochangan {
    ...
    const FString UEDeclarationFilePath = IPuertsModule::Get().GetTypingGenerateRootPath() / TEXT("ue/ue.d.ts");
// } @luochangan	
    ...
    End();
// @luochangan {
    const FString BPDeclarationFilePath = IPuertsModule::Get().GetTypingGenerateRootPath() / TEXT("ue/ue_bp.d.ts");
// } @luochangan		
...
//  @luochangan	{
    FFileHelper::LoadFileToString(
        FileContent, *(IPuertsModule::Get().GetTypingGenerateRootPath() / TEXT("ue/ue_bp.d.ts")));
// } @luochangan			
...
// @luochangan	{
        FString DialogMessage = FString::Printf(TEXT("genertate finish, %s store in %s, ([PATH=%s])"), TEXT("ue.d.ts"),
            *IPuertsModule::Get().GetTypingGenerateRootPath(), *PackagePath.ToString());
// } @luochangan	
